...
{
  auto handle = dlopen("/home/zhouhao/github/zhouhao03/MNN-dev/build/min_release/source/backend/opencl/libMNN_CL.so", RTLD_NOW);
  if (handle == nullptr) {
	...
	int isVedio = 0;
    #if 1
    std::string model_name = "/home/zhouhao/github/zhouhao03/MNN-dev/resource/zhouhao03/yolov5_jjw/yolov5s.mnn";
    int num_classes=80;
    ...
    std::string model_name = "/home/zhouhao/github/zhouhao03/MNN-dev/resource/zhouhao03/yolov5_jjw/yolov5ss.mnn";
    int num_classes=5;
	...
	if (argc > 3) {
        backendConfig.precision = (MNN::BackendConfig::PrecisionMode)::atoi(argv[3]);
    }
	...
	while(1)
	{
		...
		// timecost = (timeend.tv_sec*1000000lu+timeend.tv_usec) - (timestart.tv_sec*1000000lu+timestart.tv_usec);
		// printf( "copyFromHostTensor timecost = %.4f ms\n", (double)timecost/1000.0f);
        ...
        gettimeofday(&timeend, NULL);
		timecost = (timeend.tv_sec*1000000lu+timeend.tv_usec) - (timestart.tv_sec*1000000lu+timestart.tv_usec);
		printf( "net->runSession timecost = %.4f ms\n", (double)timecost/1000.0f);
	...
	// 		cv::imwrite("/home/zhouhao/github/zhouhao03/MNN-dev/resource/zhouhao03/yolov5_jjw/output.jpg", img_src);
	// 		cv::waitKey(1);
	// 		}

    //   cv::imwrite("/home/zhouhao/github/zhouhao03/MNN-dev/resource/zhouhao03/yolov5_jjw/output_1.jpg", img_src);
